...
class DevicesPage(BasePage):
    ...
    def filter_by_status(self, status: str) -> None:
        ...
        self.page.locator(
            f'[role="option"][data-value="{status.lower()}"]'
        ).first.click()
        self.page.wait_for_timeout(500)
    ...
    def fill_device_form(
        ...
        self.page.locator(
            f'[role="option"][data-value="{device_type.lower()}"]'
        ).first.click()
    ...
    def save_device(self) -> None:
        ...
        self.page.wait_for_selector(
            self.DEVICE_NAME_INPUT, state="hidden", timeout=5000
        )
    ...
    def is_device_visible(self, name: str) -> bool:
        ...
        return self.page.locator(
            f"{self.DEVICE_TABLE} tr:has-text('{name}')"
        ).is_visible()
