...
def test_get_alerts_returns_expected_fields(api_base_url, api_client):
    ...
    if data["total"] > 0:
        ...
        expected_fields = [
            "id", "device_id", "device_name", "severity", 
            "type", "message", "timestamp", "acknowledged"
        ]
...
def test_get_alerts_filter_by_acknowledged(api_base_url, api_client):
    ...
    response = api_client.get(f"{api_base_url}/alerts", params={"acknowledged": "false"})
...
def test_acknowledge_alert(api_base_url, api_client):
    ...
    list_response = api_client.get(f"{api_base_url}/alerts", params={"acknowledged": "false"})
    alerts = list_response.json()["alerts"]
...
def test_acknowledge_already_acknowledged_alert(api_base_url, api_client):
    ...
    list_response = api_client.get(f"{api_base_url}/alerts", params={"acknowledged": "true"})
    alerts = list_response.json()["alerts"]
