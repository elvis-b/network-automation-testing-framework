...
class TestAuthenticationErrors:
    ...
    def test_access_with_expired_token_format(
        self,
        api_session,
        api_base_url
    ):
...
class TestValidationErrors:
    ...
    def test_create_device_missing_required_fields(
        self,
        api_client,
        api_base_url
    ):
    ...
    def test_create_device_invalid_ip_format(
        self,
        api_client,
        api_base_url
    ):
    ...
    def test_create_device_with_invalid_status(
        self,
        api_client,
        api_base_url
    ):
    ...
    def test_update_device_with_empty_name(
        self,
        api_client,
        api_base_url
    ):
...
class TestInvalidIdFormats:
    ...
    def test_update_device_invalid_id_format(
        self,
        api_client,
        api_base_url
    ):
        ...
        response = api_client.put(
            f"{api_base_url}/devices/{invalid_id}",
            json={"status": "inactive"}
        )
        
        assert response.status_code in [400, 404, 422]

    def test_delete_device_invalid_id_format(
        self,
        api_client,
        api_base_url
    ):
...
class TestEdgeCases:
    ...
    def test_create_device_with_special_characters(
        ...
        if response.status_code == 201:
            ...
            assert "script" not in created_device["name"].lower() or \
                   created_device["name"] == special_name
    ...
    def test_login_with_sql_injection_attempt(
        ...
        response = api_session.post(f"{api_base_url}/auth/login", json=injection_attempt)
