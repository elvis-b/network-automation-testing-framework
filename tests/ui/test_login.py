...
class TestLoginPage:
    ...
    def test_successful_login_redirects_to_dashboard(self, page, frontend_url, test_credentials):
        """
    ...
    def test_login_with_invalid_credentials_shows_error(self, page, frontend_url):
        ...
        assert not login_page.is_logged_in(), "Invalid credentials should not log the user in"
    ...
    @pytest.mark.regression
    def test_login_button_disabled_during_loading(self, page, frontend_url, test_credentials):
        """
...
class TestLoginNavigation:
    ...
    def test_accessing_devices_without_auth_redirects_to_login(self, page, frontend_url):
        """
