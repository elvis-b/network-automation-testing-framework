...
class TestDeviceCRUD:
    ...
    def test_add_device_dialog_opens(self, authenticated_page, frontend_url):
        ...
        expect(authenticated_page.locator(devices_page.DEVICE_NAME_INPUT)).to_be_visible()
    ...
    def test_add_new_device(self, authenticated_page, frontend_url, test_device_name):
        ...
        assert new_count >= initial_count, "Device count should not decrease after adding"
