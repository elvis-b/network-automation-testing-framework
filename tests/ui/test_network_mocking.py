...
class TestNetworkMocking:
    ...
    def test_handles_api_500_error_gracefully(self, page, frontend_url, test_credentials):
        """
    ...
    def test_handles_api_404_not_found(self, page, frontend_url, test_credentials):
        ...
        page.route("**/api/devices/nonexistent-id", lambda route: route.fulfill(
            status=404,
            content_type="application/json",
...
class TestRequestInterception:
    ...
    def test_intercept_and_modify_request_headers(self, page, frontend_url, test_credentials):
        """
...
class TestResponseValidation:
    ...
    def test_verify_api_response_structure(self, page, frontend_url, test_credentials):
        ...
        if captured_response and isinstance(captured_response, list) and len(captured_response) > 0:
