...
class TestVisualRegression:
    ...
    def test_login_page_visual(self, visual_page, frontend_url):
        ...
        assert matches, f"Visual difference of {diff_pct:.2%} exceeds threshold. Check {diff_path}"
    ...
    def test_login_page_with_error(self, visual_page, frontend_url):
        ...
        matches, diff_pct = compare_screenshots(baseline_path, actual_path, diff_path, threshold=0.15)
        assert matches, f"Visual difference of {diff_pct:.2%} exceeds threshold."

    def test_dashboard_visual_authenticated(self, visual_page, frontend_url, test_credentials):
        """
        ...
        matches, diff_pct = compare_screenshots(baseline_path, actual_path, diff_path, threshold=0.70)
        assert matches, f"Visual difference of {diff_pct:.2%} exceeds threshold."
